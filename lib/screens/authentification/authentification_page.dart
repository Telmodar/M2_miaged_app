    ...
    return loading
        ...
        : Scaffold(
            ...
            appBar: AppBar(
              ...
              elevation: 0.0,
              title:
                  Text(showSignIn ? 'Log In to Miaged' : 'Register to Miaged'),
              actions: <Widget>[
                TextButton.icon(
                  icon: Icon(
                      showSignIn
                      ...
                      color: Colors.black),
                  label: Text(showSignIn ? 'Register' : 'Log In',
                  ...
                  children: [
                    ...
                    !showSignIn
                        ? TextFormField(
                            ...
                            validator: (value) =>
                                value.isEmpty ? "What your name ?" : null,
                          )
                    ...
                    TextFormField(
                      ...
                      decoration: textInputDecoration.copyWith(
                          labelText: 'Mail', hintText: 'mail'),
                      validator: (value) =>
                          value.isEmpty ? "What's your mail address ?" : null,
                    ),
                    ...
                    TextFormField(
                      ...
                      validator: (value) => value.length < 6
                          ? "Please enter a securized password of more than 6 characters"
                          : null,
                    ),
                    SizedBox(height: 10.0),
                    ...
                    ElevatedButton(
                      //child: Text('Log In'),
                      child: Text(showSignIn ? "Log In" : "Register",
                        ...
                        if (_formKey.currentState.validate()) {
                          ...
                          dynamic result = showSignIn
                              ? await _auth.signInWithMailAndPassword(
                                  mail, password)
                              : await _auth.registerInWithMailAndPassword(
                                  name, mail, password);
