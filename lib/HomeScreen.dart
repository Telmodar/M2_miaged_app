...
import 'package:miaged_app/SearchProduct.dart';
import 'package:miaged_app/globalVar.dart';
import 'package:miaged_app/imageSliderScreen.dart';
import 'package:miaged_app/profileScreen.dart';
import 'package:miaged_app/uploadAdScreen.dart';
    ...
    return showDialog(
      ...
      builder: (BuildContext context){
        return SingleChildScrollView(
          child: AlertDialog(
            title: Text("Update   Data", style: TextStyle(fontSize: 24, fontFamily: "Boogaloo", letterSpacing: 2.0),),
            content: Column(
